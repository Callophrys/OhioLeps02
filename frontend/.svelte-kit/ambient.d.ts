...
declare module '$env/static/private' {
	...
	export const BAT_CONFIG_PATH: string;
	...
	export const DIRS_LIST: string;
	export const DIRS_POSITION: string;
	export const DOTNET_UPGRADEASSISTANT_TELEMETRY_OPTOUT: string;
	...
	export const JIRA_ATTACHMENTS_DIR: string;
	export const JIRA_CASE_DIR: string;
	...
	export const SCOOP_CACHE: string;
	...
	export const TELEVISION_CONFIG: string;
	...
	export const WEZTERM_LOG: string;
	...
	export const _ZO_RESOLVE_SYMLINKS: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		DOTNET_UPGRADEASSISTANT_TELEMETRY_OPTOUT: string;
		DriverData: string;
		EDITOR: string;
		GOBIN: string;
		GOPATH: string;
		...
		INIT_CWD: string;
		IOLIBS: string;
		JIRA_ATTACHMENTS_DIR: string;
		JIRA_CASE_DIR: string;
