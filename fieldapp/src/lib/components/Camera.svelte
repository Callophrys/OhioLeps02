...
<button onclick={takePhoto} class="bg-indigo-400 dark:bg-indigo-800">Take Photo</button>
<button onclick={uploadPhoto} class="bg-fuchsia-400 dar:bg-fuchsia-800">Upload Now</button>
